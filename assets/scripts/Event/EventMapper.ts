...
export class EventMapper {
  public static init() {
    //error
    // NetworkEventCenter.on(NetworkEventToC.ERROR_MESSAGE_TOC, (data: error_message_toc) => {
    ...
    // });
    NetworkEventCenter.on(NetworkEventToC.HEART_TOC, (data) => {
    ...
    // });
    // NetworkEventCenter.on(NetworkEventToC.REMOVE_ONE_POSITION_TOC, (data: fengsheng.remove_one_position_toc) => {
    ...
    // // });
    // NetworkEventCenter.on(NetworkEventToC.SAVE_RECORD_SUCCESS_TOC, (data: fengsheng.save_record_success_toc) => {
    //   ProcessEventCenter.emit(ProcessEvent.SAVE_RECORD_SUCCESS, { recordId: data.recordId });
    // });
    // NetworkEventCenter.on(NetworkEventToC.GET_ROOM_INFO_TOC, (data: fengsheng.get_room_info_toc) => {
    ...
    //   });
    // });
    // NetworkEventCenter.on(NetworkEventToC.RECONNECT_TOC, (data: fengsheng.reconnect_toc) => {
    //   if (data.isEnd) {
    ...
    //   }
    // });
    // NetworkEventCenter.on(NetworkEventToC.JOIN_ROOM_TOC, (data: fengsheng.join_room_toc) => {
    ...
    //   });
    // });
    // NetworkEventCenter.on(NetworkEventToC.LEAVE_ROOM_TOC, (data: fengsheng.leave_room_toc) => {
    ...
    // });
    // NetworkEventCenter.on(NetworkEventToC.WAIT_FOR_SELECT_ROLE_TOC, (data: fengsheng.wait_for_select_role_toc) => {
    ...
    //   });
    // });
    // NetworkEventCenter.on(NetworkEventToC.AUTO_PLAY_TOC, (data: fengsheng.auto_play_toc) => {
    //   ProcessEventCenter.emit(ProcessEvent.GET_AUTO_PLAY_STATUS, { enable: data.enable });
    // });
    // NetworkEventCenter.on(NetworkEventToC.NOTIFY_PLAYER_UPDATE_TOC, (data: fengsheng.notify_player_update_toc) => {
    ...
    //   });
    // });
    // NetworkEventCenter.on(NetworkEventToC.SELECT_ROLE_TOC, (data: fengsheng.select_role_toc) => {
    //   ProcessEventCenter.emit(ProcessEvent.CONFIRM_SELECT_CHARACTER, {
    //     characterId: data.role,
    //   });
    // });
    // NetworkEventCenter.on(NetworkEventToC.INIT_TOC, (data: fengsheng.init_toc) => {
    //   const players = [];
    //   for (let i = 0; i < data.names.length; i++) {
    //     players.push({
    //       id: i,
    ...
    //   });
    // });
    // NetworkEventCenter.on(NetworkEventToC.NOTIFY_ROLE_UPDATE_TOC, (data: game.notify_role_update_toc) => {
    //   ProcessEventCenter.emit(ProcessEvent.UPDATE_CHARACTER_STATUS, {
    //     playerId: data.playerId,
    //     characterId: data.role,
    //   });
    // });
    // NetworkEventCenter.on(NetworkEventToC.ADD_CARD_TOC, (data: game.add_card_toc) => {
