...
export enum NetworkEventToC {
  ...
  SKILL_MIAO_SHOU_KUAI_JI_A_TOC = "skill_miao_shou_kuai_ji_a_toc",
  SKILL_MIAO_SHOU_KUAI_JI_B_TOC = "skill_miao_shou_kuai_ji_b_toc",
  SKILL_SHOU_KOU_RU_PING_TOC = "skill_shou_kou_ru_ping_toc",
  SKILL_WAIT_FOR_HAN_HOU_LAO_SHI_TOC = "skill_wait_for_han_hou_lao_shi_toc",
  ...
  SKILL_LIAN_LUO_TOC = "skill_lian_luo_toc",
...
export enum NetworkEventToS {
  ...
  SKILL_MIAO_SHOU_KUAI_JI_B_TOS = "skill_miao_shou_kuai_ji_b_tos",
  SKILL_HAN_HOU_LAO_SHI_TOS = "skill_han_hou_lao_shi_tos",
