...
export enum NetworkEventToC {
  ...
  SET_ROOM_EXTENSION_TOC = "set_room_extension_toc",
  ...
  NOTIFY_ROOM_START_TIMER_TOC = "notify_room_start_timer_toc",
  HEART_TOC = "heart_toc",
  ...
  SKILL_YI_HUA_JIE_MU_A_TOC = "skill_yi_hua_jie_mu_a_toc",
  SKILL_YI_HUA_JIE_MU_B_TOC = "skill_yi_hua_jie_mu_b_toc",
  ...
  SKILL_WAIT_FOR_JIU_JI_TOC = "skill_wait_for_jiu_ji_toc",
  ...
  SKILL_YING_BIAN_TOC = "skill_ying_bian_toc",
  ...
  WAIT_FOR_SKILL_CONG_RONG_YING_DUI_TOC = "wait_for_skill_cong_rong_ying_dui_toc",
  SKILL_CONG_RONG_YING_DUI_TOC = "skill_cong_rong_ying_dui_toc",
  SKILL_CHI_ZI_ZHI_XIN_A_TOC = "skill_chi_zi_zhi_xin_a_toc",
  SKILL_CHI_ZI_ZHI_XIN_B_TOC = "skill_chi_zi_zhi_xin_b_toc",
  SKILL_YUN_CHOU_WEI_WO_A_TOC = "skill_yun_chou_wei_wo_a_toc",
  SKILL_YUN_CHOU_WEI_WO_B_TOC = "skill_yun_chou_wei_wo_b_toc",
  SKILL_HOU_LAI_REN_A_TOC = "skill_hou_lai_ren_a_toc",
  SKILL_HOU_LAI_REN_B_TOC = "skill_hou_lai_ren_b_toc",
  ...
  SKILL_PIN_MING_SAN_LANG_TOC = "skill_pin_ming_san_lang_toc",
  ...
  SKILL_HUN_SHUI_MO_YU_TOC = "skill_hun_shui_mo_yu_toc",
  ...
  SKILL_WAIT_FOR_XIN_GE_LIAN_LUO_TOC = "skill_wait_for_xin_ge_lian_luo_toc",
  SKILL_XIN_GE_LIAN_LUO_TOC = "skill_xin_ge_lian_luo_toc",
  SKILL_HOU_ZI_QIE_XIN_TOC = "skill_hou_zi_qie_xin_toc",
  SKILL_WAIT_FOR_BIAN_ZE_TONG_TOC = "skill_wait_for_bian_ze_tong_toc",
  SKILL_BIAN_ZE_TONG_TOC = "skill_bian_ze_tong_toc",
  SKILL_YOU_DI_SHEN_RU_TOC = "skill_you_di_shen_ru_toc",
  SKILL_JIAN_DI_FENG_XING_A_TOC = "skill_jian_di_feng_xing_a_toc",
  SKILL_JIAN_DI_FENG_XING_B_TOC = "skill_jian_di_feng_xing_b_toc",
  SKILL_JIAN_DI_FENG_XING_C_TOC = "skill_jian_di_feng_xing_c_toc",
  ...
  SKILL_ZHUANG_ZHI_MAN_HUAI_TOC = "skill_zhuang_zhi_man_huai_toc",
...
export enum NetworkEventToS {
  ...
  SET_ROOM_EXTENSION_TOS = "set_room_extension_tos",
  ...
  USE_DIAO_HU_LI_SHAN_TOS = "use_diao_hu_li_shan_tos",
  USE_YU_QIN_GU_ZONG_TOS = "use_yu_qin_gu_zong_tos",
  ...
  SKILL_YI_HUA_JIE_MU_A_TOS = "skill_yi_hua_jie_mu_a_tos",
  SKILL_YI_HUA_JIE_MU_B_TOS = "skill_yi_hua_jie_mu_b_tos",
  ...
  SKILL_JIU_JI_A_TOS = "skill_jiu_ji_a_tos",
  ...
  SKILL_CONG_RONG_YING_DUI_TOS = "skill_cong_rong_ying_dui_tos",
  SKILL_CHI_ZI_ZHI_XIN_A_TOS = "skill_chi_zi_zhi_xin_a_tos",
  SKILL_CHI_ZI_ZHI_XIN_B_TOS = "skill_chi_zi_zhi_xin_b_tos",
  SKILL_YUN_CHOU_WEI_WO_A_TOS = "skill_yun_chou_wei_wo_a_tos",
  SKILL_YUN_CHOU_WEI_WO_B_TOS = "skill_yun_chou_wei_wo_b_tos",
  SKILL_HOU_LAI_REN_A_TOS = "skill_hou_lai_ren_a_tos",
  SKILL_HOU_LAI_REN_B_TOS = "skill_hou_lai_ren_b_tos",
  ...
  SKILL_PIN_MING_SAN_LANG_TOS = "skill_pin_ming_san_lang_tos",
  ...
  SKILL_XIN_GE_LIAN_LUO_TOS = "skill_xin_ge_lian_luo_tos",
  SKILL_HOU_ZI_QIE_XIN_TOS = "skill_hou_zi_qie_xin_tos",
  SKILL_BIAN_ZE_TONG_TOS = "skill_bian_ze_tong_tos",
  SKILL_YOU_DI_SHEN_RU_TOS = "skill_you_di_shen_ru_tos",
  SKILL_JIAN_DI_FENG_XING_A_TOS = "skill_jian_di_feng_xing_a_tos",
  ...
  SKILL_ZHUANG_ZHI_MAN_HUAI_TOS = "skill_zhuang_zhi_man_huai_tos",
...
export enum ProcessEvent {
  ...
  GET_ROOM_START_TIME = "get_room_start_time",
  ...
  SET_ROOM_EXTENSION = "set_room_extension",
  ADD_ROBOT = "add_robot",
...
export enum GameEvent {
  ...
  SEND_PHASE_START = "send_phase_start",
  SEND_PHASE_END = "send_phase_end",
  ...
  PLAYER_SET_MESSAGE = "player_set_message",
  ...
  MESSAGE_TURNED_OVER = "message_turned_over",
...
export enum UIEvent {
  ...
  START_MARK_IDENTITY = "start_mark_identity",
